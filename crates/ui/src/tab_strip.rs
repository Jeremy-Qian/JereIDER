...
use jereide_core::constants::{
    ...
    TAB_CLOSE_STROKE, TAB_MODIFIED_DOT_RADIUS, TAB_PAD_LEFT, TAB_PAD_RIGHT,
    TAB_STRIP_HEIGHT,
};
use jereide_settings::{
    ACCENT, BORDER, ELEVATED_BG, HOVER_BG, SURFACE_BG, TAB_FONT_SIZE,
    TEXT_DEFAULT, TEXT_PRIMARY, TEXT_SECONDARY,
};
